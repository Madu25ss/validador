...
return (
  ...
  <div className="flex flex-col bg-stone-100 h-screen px-24 py-8">
    <h1 className="mt-4 text-3xl font-light text-center text-zinc-600">Validador CPF</h1>
      <main className="mt8">
        {/* como deixar no- meio??? */}
        <div className="">
        <TesteComponente />

        <Input name={"cpf"} value={cpf} onChange={(text: string)=> setCpf(text)} maxLength={11} placeholder="Digite o CPF"/>
